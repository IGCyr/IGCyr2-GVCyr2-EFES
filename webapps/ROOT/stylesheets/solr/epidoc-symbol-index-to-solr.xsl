...
<xsl:stylesheet exclude-result-prefixes="#all"
  ...
  <xsl:template match="/">
    <add>
      <xsl:for-each-group select="//tei:g[@ref or @type and not(@type=('acrophonic','alphabetic','papyrologic','cyrnum','abbreviation'))][ancestor::tei:div/@type='edition']" group-by="normalize-unicode(concat(string-join(., ''), '-', @ref, '-', @type))">
