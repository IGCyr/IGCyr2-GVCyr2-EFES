...
#. View HTML versions of the XML at http://localhost:9999/en/text/<filename>.html (TEI) and http://localhost:9999/en/<filename>.html (EpiDoc) [filetype extensions not included in <filename>]
